...
function(find_package_library NAME LIBNAME LIBPATH_D LIBPATH_R)
  ...
  if(WIN32)
    ...
    set(${NAME}_${LIBNAME}_DLL_D ${${NAME}_${LIBNAME}_LIBPATH_D}/${LIBNAME}d.dll)
    set(${NAME}_${LIBNAME}_DLL_R ${${NAME}_${LIBNAME}_LIBPATH_R}/${LIBNAME}.dll)
  else(WIN32)
...
function(find_package_unique_library NAME LIBNAME LIBPATH)
  ...
  if(WIN32)
    ...
    set(${NAME}_${LIBNAME}_DLL ${${NAME}_${LIBNAME}_LIBPATH}/${LIBNAME}.dll)
  else(WIN32)
