...
function(find_package_library NAME LIBNAME LIBPATH_D LIBPATH_R)
  ...
  if(${NAME}_${LIBNAME}_LIB_D)
    ...
    set_target_properties(${NAME}::${LIBNAME} PROPERTIES
      ...
      IMPORTED_LOCATION_DEBUG ${${NAME}_${LIBNAME}_LIBPATH_D}/${LIBNAME}d.dll)
  ...
  if(${NAME}_${LIBNAME}_LIB_R)
    ...
    set_target_properties(${NAME}::${LIBNAME} PROPERTIES
      ...
      IMPORTED_LOCATION_RELEASE ${${NAME}_${LIBNAME}_LIBPATH_R}/${LIBNAME}.dll
      IMPORTED_LOCATION_MINSIZEREL ${${NAME}_${LIBNAME}_LIBPATH_R}/${LIBNAME}.dll
      IMPORTED_LOCATION_RELWITHDEBINFO ${${NAME}_${LIBNAME}_LIBPATH_R}/${LIBNAME}.dll)
