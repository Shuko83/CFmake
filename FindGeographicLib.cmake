...
set(DELIVERY_DIR "C:/tt4-cmake/Starlinx/external/GeographicLib/Delivery/win-msvc2015-x64/static/debug")
...
continue()
  ...
  if (NOT TARGET ${fileName})
    ...
    set_target_properties(${fileName} PROPERTIES INTERFACE_INCLUDE_DIRECTORIES C:/tt4-cmake/Starlinx/external/GeographicLib/Delivery/include)
    add_library("GeographicLib" ALIAS ${fileName})
endif()
endforeach()
