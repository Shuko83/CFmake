...
set(DELIVERY_DIR "C:/tt4-cmake/Starlinx/Modules/DLPX/HI/Models/TnpSettings/L16/ED8/Delivery")
...
add_library(${fileName} SHARED IMPORTED)
  ...
  set_target_properties(${fileName} PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "${DELIVERY_DIR}/include;${DELIVERY_DIR}/include/TnpSettingsL16/ConfigReaders;${DELIVERY_DIR}/include/TnpSettingsL16/ConfigWriters;${DELIVERY_DIR}/include/TnpSettingsL16/Objects")
endif()
endforeach()
