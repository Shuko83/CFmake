...
set(DELIVERY_DIR "C:/tt4-cmake/Starlinx/Modules/DLPX/HI/Models/MdlpSurv/Delivery")
...
add_library(${fileName} SHARED IMPORTED)
  ...
  set_target_properties(${fileName} PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "${DELIVERY_DIR}/include;${DELIVERY_DIR}/include/MDlpSurv/Objects;${DELIVERY_DIR}/include/MDlpSurv/OrderReaders;${DELIVERY_DIR}/include/MDlpSurv/OrderWriters;${DELIVERY_DIR}/include/MDlpSurv/ReportReaders;${DELIVERY_DIR}/include/MDlpSurv/ReportWriters")
endif()
endforeach()
