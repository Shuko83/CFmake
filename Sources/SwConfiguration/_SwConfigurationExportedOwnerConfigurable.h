/*!
 \file _SwConfigurationExportedOwnerConfigurable.h
...
#ifndef __SwConfigurationExportedOwnerConfigurable_H
#define __SwConfigurationExportedOwnerConfigurable_H
...
/*!
	\class _SwConfigurationExportedOwnerConfigurable 
	\brief Class implementant une entite exportable executable
*/
class _SwConfigurationExportedOwnerConfigurable : 
	...
	public:
		/*! \brief Constructeur */
		_SwConfigurationExportedOwnerConfigurable();
	    /*! \brief Destructeur */
		virtual ~_SwConfigurationExportedOwnerConfigurable();
        ...
        //---------------------------------------------------------------------
        // Interface ISwOwnerConfigurable_SwService
        //---------------------------------------------------------------------
        ...
        //----------------------------------------------------
		virtual void Update(StreamWork::SwCore::ISwObservable *);
};
