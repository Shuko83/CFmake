...
_SwGuiCompPluginsTree::_SwGuiCompPluginsTree()
	...
	,_window_title (QStringLiteral("Plugins List"))
{	
}
/*! \brief Destructeur */
_SwGuiCompPluginsTree::~_SwGuiCompPluginsTree(){
...
void _SwGuiCompPluginsTree::InitializeResources() throw(SwException) {
    ...
    _action=new QAction(QIcon(":/SwGui/plugins.png"),QString("Plugins list"),nullptr);
    connect(_action, &QAction::triggered, this, &_SwGuiCompPluginsTree::showplugins);
    ...
    _provider_service->RegisterProvidedInterface<QAction>("Action",_action);
...
void _SwGuiCompPluginsTree::showplugins() {
    _SwGuiPluginsFrontEnd * dialog=new _SwGuiPluginsFrontEnd(nullptr);
