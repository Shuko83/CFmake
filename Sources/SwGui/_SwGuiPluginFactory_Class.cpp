...
void _SwGuiPluginFactory_Class::OnRegisterService(ISwService * service)
{
	...
	if ( eservice )
	{
		...
		eservice->registerExtension<ISwDockWidget>("DockWidget", GetPluginName(), "SwGuiDockWidget");
		eservice->registerExtension<ISwListDockWidget>("ListDockWidget", GetPluginName(), "SwGuiListDockWidget");
		eservice->registerExtension<QWidget>("Widget", GetPluginName(), "SwGuiFrame");
		eservice->registerExtension<QWidget>("Widget", GetPluginName(), "SwGuiScrollArea");
		eservice->registerExtension<QWidget>("GridLayout", GetPluginName(), "SwGuiGridLayout");
		eservice->registerExtension<QWidget>("Widget", GetPluginName(), "SwGuiGroupBox");
		eservice->registerExtension<QWidget>("Layout", GetPluginName(), "SwGuiHorizontalLayout");
		eservice->registerExtension<ISwHttpServer>("ISwHttpServer", GetPluginName(), "SwGuiHttpServer");
		eservice->registerExtension<QWidget>("Widget", GetPluginName(), "SwGuiLabel");
		...
		eservice->registerExtension<QWidget>("Widget", GetPluginName(), "SwGuiTabWidget");
		eservice->registerExtension<ISwToolBar>("ToolBar", GetPluginName(), "SwGuiToolBar");
		eservice->registerExtension<QWidget>("Widget", GetPluginName(), "SwGuiTreeView");
		eservice->registerExtension<QWidget>("Layout", GetPluginName(), "SwGuiVerticalLayout");
		eservice->registerExtension<QWidget>("logConsole", GetPluginName(), "SwGuiVisualLogConsole");
		eservice->registerExtension<QWidget>("Widget", GetPluginName(), "SwGuiWidget");
		eservice->registerExtension<QWidget>("Widget", GetPluginName(), "SwPerspectivesManager");
		eservice->registerExtension<QWidget>("Widget", GetPluginName(), "SwGuiPushButtonToQAction");
		eservice->registerExtension<QWidget>("Widget", GetPluginName(), "SwActionToToolButton");
	}
}
...
//-------------------------------------------------------------------------
QDateTime _SwGuiPluginFactory_Class::GetPluginCompilationDate()
{
