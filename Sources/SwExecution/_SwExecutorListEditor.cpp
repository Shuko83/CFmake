...
_SwExecutorListEditor::_SwExecutorListEditor ( QWidget * parent, SwComponent_Class * root_component, QList<QString> * liste, QList<_SwExecutionMode> * liste_mode ) :QWidget ( parent )
{
	...
	if (_path_list )
	{
		while ( _sel_list.count () < _path_list->count () )
			_sel_list.push_back ( false );
	}
...
//-----------------------------------------------------------------------
_SwExecutorListEditor::_SwExecutorListEditor ( QWidget * parent ) : _SwExecutorListEditor ( parent, nullptr, nullptr, nullptr )
{
...
void _SwExecutorListEditor::paintEvent ( QPaintEvent *event )
{
	...
	painter.save ();
	QPen tmp;
	tmp.setColor ( QColor (160,160,160) );
	tmp.setWidth ( 1 );
	painter.setPen ( tmp );
...
//-----------------------------------------------------------------------
void _SwExecutorListEditor::setPath_list ( QList<QString> * val )
{
	_path_list = val;
