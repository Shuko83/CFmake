...
set(DELIVERY_DIR "C:/tt4-cmake/Starlinx/Modules/DLPX/HI/Models/MdlpSettings/Delivery")
...
add_library(${fileName} SHARED IMPORTED)
  ...
  set_target_properties(${fileName} PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "${DELIVERY_DIR}/include;${DELIVERY_DIR}/include/MDlpSettings/ConfigReaders;${DELIVERY_DIR}/include/MDlpSettings/ConfigWriters;${DELIVERY_DIR}/include/MDlpSettings/Objects;")
endif()
endforeach()
