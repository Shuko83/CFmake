...
set(DELIVERY_DIR "C:/tt4-cmake/Starlinx/Modules/DLPX/HI/Models/DlpxStates/Delivery")
...
add_library(${fileName} SHARED IMPORTED)
  ...
  set_target_properties(${fileName} PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "${DELIVERY_DIR}/include;${DELIVERY_DIR}/include/DlpxStates/Objects;${DELIVERY_DIR}/include/DlpxStates/OrderReaders;${DELIVERY_DIR}/include/DlpxStates/OrderWriters;${DELIVERY_DIR}/include/DlpxStates/ReportReaders;${DELIVERY_DIR}/include/DlpxStates/ReportWriters")
endif()
endforeach()
