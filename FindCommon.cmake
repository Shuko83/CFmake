...
set(DELIVERY_DIR "C:/tt4-cmake/Starlinx/Modules/DLPX/HI/Common/Delivery")
...
add_library(${fileName} SHARED IMPORTED)
  ...
  set_target_properties(${fileName} PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "${DELIVERY_DIR}/include;${DELIVERY_DIR}/include/DlpxHiCommon")
endif()
endforeach()
