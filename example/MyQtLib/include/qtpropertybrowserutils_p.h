...
private:
    ...
    QStringList _cursorNames;
    QMap< int, QIcon > _cursorIcons;
    QMap< int, Qt::CursorShape > _valueToCursorShape;
    QMap< Qt::CursorShape, int > _cursorShapeToValue;
};
...
public:
    ...
    bool textVisible() const { return _textVisible; }
