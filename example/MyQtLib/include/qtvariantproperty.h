...
class SN_WIDGETS_EXPORT QtVariantProperty : public QtProperty
{
public:
    ~QtVariantProperty();
...
class SN_WIDGETS_EXPORT QtVariantPropertyManager : public QtAbstractPropertyManager
{
    Q_OBJECT
public:
...
private:
    ...
    Q_PRIVATE_SLOT( d_func(), void slotValueChanged( QtProperty *, unsigned int ) )
    Q_PRIVATE_SLOT( d_func(), void slotRangeChanged( QtProperty *, unsigned int, unsigned int ) )
    Q_PRIVATE_SLOT( d_func(), void slotValueChanged( QtProperty *, long long ) )
    Q_PRIVATE_SLOT( d_func(), void slotRangeChanged( QtProperty *, long long, long long ) )
    Q_PRIVATE_SLOT( d_func(), void slotValueChanged( QtProperty *, unsigned long long ) )
    Q_PRIVATE_SLOT( d_func(), void slotRangeChanged( QtProperty *, unsigned long long, unsigned long long ) )
...
class SN_WIDGETS_EXPORT QtVariantEditorFactory : public QtAbstractEditorFactory< QtVariantPropertyManager >
{
    Q_OBJECT
public:
