...
class SN_WIDGETS_EXPORT QtProperty
{
public:
    virtual ~QtProperty();
...
class SN_WIDGETS_EXPORT QtAbstractPropertyManager : public QObject
{
    Q_OBJECT
public:
...
public:
    ...
    {
        QSetIterator< PropertyManager * > it( _managers );
        while( it.hasNext() )
        {
    ...
    PropertyManager * propertyManager( QtProperty * property ) const
    {
        ...
        QSetIterator< PropertyManager * > itManager( _managers );
...
private:
    QSet< PropertyManager * > _managers;
...
class SN_WIDGETS_EXPORT QtBrowserItem
{
public:
...
class SN_WIDGETS_EXPORT QtAbstractPropertyBrowser : public QWidget
{
    Q_OBJECT
public:
