...
class SN_WIDGETS_EXPORT QtGroupPropertyManager : public QtAbstractPropertyManager
{
    Q_OBJECT
public:
...
class SN_WIDGETS_EXPORT QtIntPropertyManager : public QtAbstractPropertyManager
{
    Q_OBJECT
public:
...
class SN_WIDGETS_EXPORT QtUIntPropertyManager : public QtAbstractPropertyManager
{
    Q_OBJECT
public:
    QtUIntPropertyManager( QObject * parent = 0 );
...
protected:
    ...
    virtual void uninitializeProperty( QtProperty * property );
private:
    QScopedPointer< QtUIntPropertyManagerPrivate > d_ptr;
    Q_DECLARE_PRIVATE( QtUIntPropertyManager )
    Q_DISABLE_COPY( QtUIntPropertyManager )
};

class QtLongLongPropertyManagerPrivate;

class SN_WIDGETS_EXPORT QtLongLongPropertyManager : public QtAbstractPropertyManager
{
    Q_OBJECT
public:
    QtLongLongPropertyManager( QObject * parent = 0 );
    ~QtLongLongPropertyManager();
    
    long long value( const QtProperty * property ) const;
    long long minimum( const QtProperty * property ) const;
    long long maximum( const QtProperty * property ) const;
    
public Q_SLOTS:
    void setValue( QtProperty * property, long long val );
    void setMinimum( QtProperty * property, long long minVal );
    void setMaximum( QtProperty * property, long long maxVal );
    void setRange( QtProperty * property, long long minVal, long long maxVal );
Q_SIGNALS:
    void valueChanged( QtProperty * property, long long val );
    void rangeChanged( QtProperty * property, long long minVal, long long maxVal );
protected:
    QString valueText( const QtProperty * property ) const;
    virtual void initializeProperty( QtProperty * property );
    virtual void uninitializeProperty( QtProperty * property );
private:
    QScopedPointer< QtLongLongPropertyManagerPrivate > d_ptr;
    Q_DECLARE_PRIVATE( QtLongLongPropertyManager )
    Q_DISABLE_COPY( QtLongLongPropertyManager )
};

class QtUnsignedLongLongPropertyManagerPrivate;

class SN_WIDGETS_EXPORT QtUnsignedLongLongPropertyManager : public QtAbstractPropertyManager
{
    Q_OBJECT
public:
    QtUnsignedLongLongPropertyManager( QObject * parent = 0 );
    ~QtUnsignedLongLongPropertyManager();
    
    unsigned long long value( const QtProperty * property ) const;
    unsigned long long minimum( const QtProperty * property ) const;
    unsigned long long maximum( const QtProperty * property ) const;
    
public Q_SLOTS:
    void setValue( QtProperty * property, unsigned long long val );
    void setMinimum( QtProperty * property, unsigned long long minVal );
    void setMaximum( QtProperty * property, unsigned long long maxVal );
    void setRange( QtProperty * property, unsigned long long minVal, unsigned long long maxVal );
Q_SIGNALS:
    void valueChanged( QtProperty * property, unsigned long long val );
    void rangeChanged( QtProperty * property, unsigned long long minVal, unsigned long long maxVal );
protected:
    QString valueText( const QtProperty * property ) const;
    virtual void initializeProperty( QtProperty * property );
    virtual void uninitializeProperty( QtProperty * property );
private:
    QScopedPointer< QtUnsignedLongLongPropertyManagerPrivate > d_ptr;
    Q_DECLARE_PRIVATE( QtUnsignedLongLongPropertyManager )
    Q_DISABLE_COPY( QtUnsignedLongLongPropertyManager )
};

class QtBoolPropertyManagerPrivate;

class SN_WIDGETS_EXPORT QtBoolPropertyManager : public QtAbstractPropertyManager
{
    Q_OBJECT
public:
...
class SN_WIDGETS_EXPORT QtDoublePropertyManager : public QtAbstractPropertyManager
{
    Q_OBJECT
public:
...
class SN_WIDGETS_EXPORT QtStringPropertyManager : public QtAbstractPropertyManager
{
    Q_OBJECT
public:
    ...
    int length( const QtProperty * property ) const;
    
public Q_SLOTS:
    void setValue( QtProperty * property, const QString & val );
    void setRegExp( QtProperty * property, const QRegExp & regExp );
    void setLength( QtProperty * property, int length );
Q_SIGNALS:
    void valueChanged( QtProperty * property, const QString & val );
    void regExpChanged( QtProperty * property, const QRegExp & regExp );
    void lengthChanged( QtProperty * property, int );
protected:
    QString valueText( const QtProperty * property ) const;
    virtual void initializeProperty( QtProperty * property );
    virtual void uninitializeProperty( QtProperty * property );
...
class SN_WIDGETS_EXPORT QtDatePropertyManager : public QtAbstractPropertyManager
{
    Q_OBJECT
public:
...
class SN_WIDGETS_EXPORT QtTimePropertyManager : public QtAbstractPropertyManager
{
    Q_OBJECT
public:
...
class SN_WIDGETS_EXPORT QtDateTimePropertyManager : public QtAbstractPropertyManager
{
    Q_OBJECT
public:
...
class SN_WIDGETS_EXPORT QtKeySequencePropertyManager : public QtAbstractPropertyManager
{
    Q_OBJECT
public:
...
class SN_WIDGETS_EXPORT QtCharPropertyManager : public QtAbstractPropertyManager
{
    Q_OBJECT
public:
...
class SN_WIDGETS_EXPORT QtLocalePropertyManager : public QtAbstractPropertyManager
{
    Q_OBJECT
public:
...
class SN_WIDGETS_EXPORT QtPointPropertyManager : public QtAbstractPropertyManager
{
    Q_OBJECT
public:
...
class SN_WIDGETS_EXPORT QtPointFPropertyManager : public QtAbstractPropertyManager
{
    Q_OBJECT
public:
...
class SN_WIDGETS_EXPORT QtSizePropertyManager : public QtAbstractPropertyManager
{
    Q_OBJECT
public:
...
class SN_WIDGETS_EXPORT QtSizeFPropertyManager : public QtAbstractPropertyManager
{
    Q_OBJECT
public:
...
class SN_WIDGETS_EXPORT QtRectPropertyManager : public QtAbstractPropertyManager
{
    Q_OBJECT
public:
...
class SN_WIDGETS_EXPORT QtRectFPropertyManager : public QtAbstractPropertyManager
{
    Q_OBJECT
public:
...
class SN_WIDGETS_EXPORT QtEnumPropertyManager : public QtAbstractPropertyManager
{
    Q_OBJECT
public:
...
class SN_WIDGETS_EXPORT QtFlagPropertyManager : public QtAbstractPropertyManager
{
    Q_OBJECT
public:
...
class SN_WIDGETS_EXPORT QtSizePolicyPropertyManager : public QtAbstractPropertyManager
{
    Q_OBJECT
public:
...
class SN_WIDGETS_EXPORT QtFontPropertyManager : public QtAbstractPropertyManager
{
    Q_OBJECT
public:
...
class SN_WIDGETS_EXPORT QtColorPropertyManager : public QtAbstractPropertyManager
{
    Q_OBJECT
public:
...
class SN_WIDGETS_EXPORT QtCursorPropertyManager : public QtAbstractPropertyManager
{
    Q_OBJECT
public:
