# Modfied file from FindBoost Offcial CMake module from cmake 3.30.5
# Correctly declare boost as shared library on Windows
# Necessary up to Boost 1.72
# Boost 1.73 and above come with its own correct BoostConfig file
    ...
    if(_Boost_IMPORTED_TARGETS AND NOT TARGET Boost::${COMPONENT})
      ...
      if(Boost_${UPPERCOMPONENT}_FOUND)
        ...
        if(EXISTS "${Boost_${UPPERCOMPONENT}_LIBRARY}")
          if(WIN32)
            string(REPLACE ".lib" ".dll" Boost_${UPPERCOMPONENT}_RUNTIME "${Boost_${UPPERCOMPONENT}_LIBRARY}")
            set_target_properties(Boost::${COMPONENT} PROPERTIES
              IMPORTED_LINK_INTERFACE_LANGUAGES "CXX"
              IMPORTED_IMPLIB "${Boost_${UPPERCOMPONENT}_LIBRARY}"
              IMPORTED_LOCATION "${Boost_${UPPERCOMPONENT}_RUNTIME}")
          else()
            set_target_properties(Boost::${COMPONENT} PROPERTIES
              IMPORTED_LINK_INTERFACE_LANGUAGES "CXX"
        ...
        if(EXISTS "${Boost_${UPPERCOMPONENT}_LIBRARY_RELEASE}")
          ...
          if(WIN32)
            string(REPLACE ".lib" ".dll" Boost_${UPPERCOMPONENT}_RUNTIME_RELEASE "${Boost_${UPPERCOMPONENT}_LIBRARY_RELEASE}")
            set_target_properties(Boost::${COMPONENT} PROPERTIES
              IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
              IMPORTED_IMPLIB_RELEASE "${Boost_${UPPERCOMPONENT}_LIBRARY_RELEASE}"
              IMPORTED_LOCATION_RELEASE "${Boost_${UPPERCOMPONENT}_RUNTIME_RELEASE}")
          else()
            set_target_properties(Boost::${COMPONENT} PROPERTIES
              IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
        ...
        if(EXISTS "${Boost_${UPPERCOMPONENT}_LIBRARY_DEBUG}")
          ...
          if(WIN32)
            string(REPLACE ".lib" ".dll" Boost_${UPPERCOMPONENT}_RUNTIME_DEBUG "${Boost_${UPPERCOMPONENT}_LIBRARY_DEBUG}")
            set_target_properties(Boost::${COMPONENT} PROPERTIES
              IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
              IMPORTED_IMPLIB_DEBUG "${Boost_${UPPERCOMPONENT}_LIBRARY_DEBUG}"
              IMPORTED_LOCATION_DEBUG "${Boost_${UPPERCOMPONENT}_RUNTIME_DEBUG}")
          else()
            set_target_properties(Boost::${COMPONENT} PROPERTIES
              IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
