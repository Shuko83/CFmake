...
function(define_component)
  ...
  set(COMPONENT_RESSOURCES_PATH ${CMAKE_CURRENT_SOURCE_DIR})
  ...
  if(NOT COMPONENT_RECURSIVE)
    ...
    file(GLOB COMPONENT_RESSOURCES_FILES ${COMPONENT_RESSOURCES_PATH}/*.qrc)
    ...
    file(GLOB_RECURSE COMPONENT_RESSOURCES_FILES ${COMPONENT_RESSOURCES_PATH}/*.qrc)
  ...
  if(NOT COMPONENT_EXECUTABLE)
    if(NOT COMPONENT_STATIC AND NOT COMPONENT_INTERFACE)
      add_library(${COMPONENT_NAME} SHARED ${COMPONENT_PUBLIC_HEADERS_FILES} ${COMPONENT_PRIVATE_HEADERS_FILES} ${COMPONENT_SOURCES_FILES} ${COMPONENT_RCFILE_OUT} ${COMPONENT_UI_FILES} ${COMPONENT_RESSOURCES_FILES})
