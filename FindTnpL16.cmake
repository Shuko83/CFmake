...
set(DELIVERY_DIR "C:/tt4-cmake/Starlinx/Modules/DLPX/HI/Models/Tnp/L16/ED8/Delivery")
...
add_library(${fileName} SHARED IMPORTED)
  ...
  set_target_properties(${fileName} PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "${DELIVERY_DIR}/include;${DELIVERY_DIR}/include/TnpL16/Objects;${DELIVERY_DIR}/include/TnpL16/OrderReaders;${DELIVERY_DIR}/include/TnpL16/OrderWriters;${DELIVERY_DIR}/include/TnpL16/ReportReaders;${DELIVERY_DIR}/include/TnpL16/ReportWriters")
endif()
endforeach()
