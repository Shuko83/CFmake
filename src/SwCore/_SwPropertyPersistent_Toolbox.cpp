...
//-------------------------------------------------------------------------
void _SwPropertyPersistent_Toolbox::LoadProperty(QDomElement & property_node, ISwProperty * inProperty)
{
...
//-------------------------------------------------------------------------
void _SwPropertyPersistent_Toolbox::SaveProperty( QDomElement & parent_property_node, QDomDocument &doc, QString propCustomName, ISwProperty * inProperty, QString prefix )
{
	QVariant var;
	QDomElement elt;
...
//-------------------------------------------------------------------------
void _SwPropertyPersistent_Toolbox::createProperty(QDomElement & parent_property_node, QDomDocument &doc, ISwProperty * inProperty, QDomElement &elt, QVariant var) 
{
	QVariant tmp;
	QDomText  text_node;
...
//-------------------------------------------------------------------------
void _SwPropertyPersistent_Toolbox::setProperty(QDomElement & property_node, ISwProperty * inProperty) 
{
	QVariant var;
	QVariant tmp;
	QDomNode node;
	...
	//Type SwIntegerEnum
	if (var.userType()==qMetaTypeId<SwIntegerEnum>() && property_node.hasAttribute(CL_XML_ATT_ENUM_INTEGER)) {
	...
	//Type SwInteger
	if (var.userType()==qMetaTypeId<SwInteger>() && property_node.hasAttribute(CL_XML_ATT_INTEGER)) {
	...
	//Type SwString
	if (var.userType()==qMetaTypeId<SwString>() && property_node.hasAttribute(CL_XML_ATT_STRING)) {
	...
	//Type SwDouble
	if (var.userType()==qMetaTypeId<SwDouble>() && property_node.hasAttribute(CL_XML_ATT_DOUBLE)) {
