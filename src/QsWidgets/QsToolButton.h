...
#ifndef QS_WIDGETS_QSToolBUTTON_H
#define QS_WIDGETS_QSToolBUTTON_H

#include <QToolButton>
#include <QsWidgets_Global.h>


class QSWIDGETS_EXPORT QsToolButton : public QToolButton
{
	Q_OBJECT
...
public:
	...
	QsToolButton(QWidget *parent = 0);
	virtual ~QsToolButton();
