...
#ifndef QS_WIDGETS_QSDOUBLESPINBOX_H
#define QS_WIDGETS_QSDOUBLESPINBOX_H

#include <QDoubleSpinBox>
#include <QsWidgets_Global.h>


class QSWIDGETS_EXPORT QsDoubleSpinBox : public QDoubleSpinBox
{
    Q_OBJECT
...
public:
    QsDoubleSpinBox(QWidget *parent = 0);
	virtual ~QsDoubleSpinBox();
