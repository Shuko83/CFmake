...
namespace StreamWork
{
    namespace SwCore
    {
        ...
        @ingroup SwCore
        */
        class _SwServiceAlert: virtual public ISwServiceAlert
		{
        public:
			...
			virtual void raiseError(alert::IError * error);
			virtual void raiseError(alert::IError * error, double timeOut);
			virtual void raiseErrorEnd(alert::IError * error);
			virtual void raiseErrorEnd(alert::IErrorEnd *errorEnd);
