...
/*! \brief Constructeur */
_SwExecutionSetup::_SwExecutionSetup(QWidget *parent,SwComponent_Class * root_component,QList<QString> * current_list)
    : QDialog(parent)
{
    ...
    _SwExecutorListEditor * list_view=new _SwExecutorListEditor(this,_root_component,&_exe_paths);
