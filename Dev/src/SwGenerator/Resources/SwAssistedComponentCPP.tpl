...
//-------------------------------------------------------------------------
{{COMPONENT_NAME}}::{{COMPONENT_NAME}}(): SwAssistedComponent()
{
	...
	{{/SECTION_HAS_PIN}}{{#SECTION_INTERFACECONSUMED}}{{CONSUMED_VAR_NAME}} = NULL;
	{{/SECTION_INTERFACECONSUMED}}{{#SECTION_INTERFACEPRODUCTED}}{{PRODUCTED_VAR_NAME}} = NULL;
...
//-------------------------------------------------------------------------
void {{COMPONENT_NAME}}::initializeComponent() throw(SwException)
{
	{{#SECTION_HAS_PIN}}//---------------------------------------------------
	//				Gestion des pins
	//---------------------------------------------------
...
{{#SECTION_ISCONSUMED}}
//-------------------------------------------------------------------------
void {{COMPONENT_NAME}}::interfaceUnavailable( QString interface_name )
{
...
//-------------------------------------------------------------------------
void {{COMPONENT_NAME}}::interfaceAvailable( QString interface_name )
{
	{{#SECTION_INTERFACECONSUMED}}if(interface_name == "{{INTERFACE_NAME}}")
	{
