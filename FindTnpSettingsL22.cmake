...
set(DELIVERY_DIR "C:/tt4-cmake/Starlinx/Modules/DLPX/HI/Models/TnpSettings/L22/ED6/Delivery")
...
add_library(${fileName} SHARED IMPORTED)
  ...
  set_target_properties(${fileName} PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "${DELIVERY_DIR}/include;${DELIVERY_DIR}/include/TnpSettingsL22/ConfigReaders;${DELIVERY_DIR}/include/TnpSettingsL22/ConfigWriters;${DELIVERY_DIR}/include/TnpSettingsL22/Objects")
endif()
endforeach()
