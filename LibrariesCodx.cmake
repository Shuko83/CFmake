################################################################################
# CODX package libraries finder
################################################################################

function(find_codx_package_libraries NAME PATTERN LIBNAMES INCPATH LIBPATH_D LIBPATH_R)
  ...
  foreach(LIBNAME IN LISTS LIBNAMES)
    find_codx_package_library(${NAME} ${PATTERN} ${LIBNAME} ${LIBPATH_D} ${LIBPATH_R})
...
endfunction(find_codx_package_libraries NAME PATTERN LIBNAMES INCPATH LIBPATH_D LIBPATH_R)

################################################################################
# CODX package library finder
################################################################################

function(find_codx_package_library NAME PATTERN LIBNAME LIBPATH_D LIBPATH_R)
  ...
  if(WIN32)
    ...
    set(${NAME}_${LIBNAME_S}_DLL_D ${${NAME}_${LIBNAME_S}_LIBPATH_D}/${LIBNAME}d.dll)
    set(${NAME}_${LIBNAME_S}_DLL_R ${${NAME}_${LIBNAME_S}_LIBPATH_R}/${LIBNAME}.dll)
  else(WIN32)
...
endfunction(find_codx_package_library NAME PATTERN LIBNAME LIBPATH_D LIBPATH_R)
