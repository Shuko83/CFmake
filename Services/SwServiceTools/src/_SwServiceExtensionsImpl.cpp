...
void _SwServiceExtensionsImpl::registerExtensionWithType(QString extension_type_name,QString extension_name,QString pluginName,QString component_name) {
    _extensions[extension_type_name].push_back(new SwExtensionImpl(extension_type_name,extension_name,pluginName,component_name));
}
