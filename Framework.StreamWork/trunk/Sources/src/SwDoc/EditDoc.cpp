...
{
	if(ManageSQL::getInstance()->isOpen())
		ui->L_Status->setPixmap(QString(":/SwDoc/database_on.png"));
	else
		ui->L_Status->setPixmap(QString(":/SwDoc/database_off.png"));
}
...
bool EditDoc::eventFilter( QObject *obj, QEvent *event )
{
	...
	if(obj == ui->L_Status)
	{
		if(event->type() == QEvent::MouseButtonRelease)
		{
			...
			ui->L_Status->setPixmap(QString(":/SwDoc/database_wait.png"));
		}
	}
