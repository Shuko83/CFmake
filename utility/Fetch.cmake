...
macro(cstoolkit_fetch_package fetch_package_name fetch_package_url)
    if(CSTOOLKIT_FETCH_${fetch_package_name}_URL)
        ...
        set(CSTOOLKIT_FETCH_${fetch_package_name}_PROJECT "${PROJECT_NAME}")
        set(CSTOOLKIT_FETCH_${fetch_package_name}_SOURCE_DIR "${CMAKE_CURRENT_SOURCE_DIR}")
        cstoolkit_download_and_extract_package("${fetch_package_name}" "${fetch_package_url}" ${ARGN})
        _cstoolkit_internal_find_package("${fetch_package_name}" "${CSTOOLKIT_EXTERNALS}/${fetch_package_name}")
    endif()
endmacro()
