...
function(cstoolkit_compute_runtime_dependencies target)
    ...
    set(PLUGINS_GENEX_DEPENDENCIES)
    ...
    while(DESTINATION_INDEX LESS PLUGINS_DESTINATION_SIZE)
        ...
        list(APPEND PLUGINS_GENEX_DEPENDENCIES ${PLUGINS_LIST_GENEX_DEPENDENCIES})
    ...
    list(APPEND ROOT_PLUGINS_LIST ${MOVE_TO_ROOT_PLUGINS} ${PLUGINS_GENEX_DEPENDENCIES})
    set(ROOT_PLUGINS_LIST "$<LIST:REMOVE_DUPLICATES,${ROOT_PLUGINS_LIST}>")
...
function(cstoolkit_get_runtime_dependencies target runtime_dependencies genex_runtime_dependencies)
    ...
    foreach(_dep ${_target_dependencies})
        if(TARGET ${_dep})
            ...
            if(_lib_type STREQUAL SHARED_LIBRARY AND NOT _dep IN_LIST ${runtime_dependencies})
