function(cstoolkit_add_target TARGET_NAME TARGET_TYPE)
    ...
    if(TARGET_EXECUTABLE)
        ...
        set(GENEX_TARGET_SONAME "${DOLLAR}<BOOL:${DOLLAR}<${DOLLAR}<PLATFORM_ID:Linux$<ANGLE-R>:${DOLLAR}<${GENEX_TARGET_SHARED}:${DOLLAR}<BOOL:${DOLLAR}<TARGET_SONAME_FILE:\\0$<ANGLE-R>$<ANGLE-R>$<ANGLE-R>$<ANGLE-R>$<ANGLE-R>")
