    ...
    if(TARGET_FILES_MODE STREQUAL "AUTO" OR TARGET_FILES_MODE STREQUAL "APPEND")
        if(NOT DEFINED TARGET_PUBLIC_HEADERS_FILES OR TARGET_FILES_MODE STREQUAL "APPEND")
            if(TARGET_PUBLIC_HEADERS_NO_EXTENSION)
                ...
                cstoolkit_file_glob_recurse_dirs(TARGET_PUBLIC_HEADERS_FILES "*.h;*.hpp;*.hxx;*.inl" "${TARGET_PUBLIC_HEADERS_DIRS}" ${TARGET_FILES_MODE})
            endif()
        endif()
        if(NOT DEFINED TARGET_PRIVATE_HEADERS_FILES OR TARGET_FILES_MODE STREQUAL "APPEND")
            cstoolkit_file_glob_recurse_dirs(TARGET_PRIVATE_HEADERS_FILES "*.h;*.hpp;*.hxx;*.inl" "${TARGET_PRIVATE_HEADERS_DIRS}" ${TARGET_FILES_MODE})
        endif()
        if(NOT DEFINED TARGET_SOURCES_FILES OR TARGET_FILES_MODE STREQUAL "APPEND")
            cstoolkit_file_glob_recurse_dirs(TARGET_SOURCES_FILES "*.c;*.cpp;*.cxx" "${TARGET_SOURCES_DIRS}" ${TARGET_FILES_MODE})
        endif()
