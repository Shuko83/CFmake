function(cstoolkit_add_target TARGET_NAME TARGET_TYPE)
    ...
    if(NOT TARGET_NO_INSTALL)
        ...
        elseif(BORLAND)
            if(TARGET_SHARED)
                install(FILES $<TARGET_FILE_DIR:${TARGET_NAME}>/$<TARGET_FILE_PREFIX:${TARGET_NAME_STATIC}>$<TARGET_FILE_BASE_NAME:${TARGET_NAME}>.tds DESTINATION ${TARGET_INSTALL_BINDIR} COMPONENT ${TARGET_INSTALL_COMPONENT} OPTIONAL ${TARGET_INSTALL_EXCLUDE_FROM_ALL})
            elseif(TARGET_EXECUTABLE)
                install(FILES $<TARGET_FILE_DIR:${TARGET_NAME}>/$<TARGET_FILE_PREFIX:${TARGET_NAME_STATIC}>$<TARGET_FILE_BASE_NAME:${TARGET_NAME}>.tds DESTINATION ${TARGET_INSTALL_SYMBOLSDIR} COMPONENT ${TARGET_INSTALL_COMPONENT} OPTIONAL ${TARGET_INSTALL_EXCLUDE_FROM_ALL})
                install(FILES "${TARGET_RUNTIME_SYMBOLS}" DESTINATION ${TARGET_INSTALL_SYMBOLSDIR} COMPONENT ${TARGET_INSTALL_COMPONENT} OPTIONAL ${TARGET_INSTALL_EXCLUDE_FROM_ALL})
            endif()
            if(TARGET_STATIC) # Not else because of SHARED_AND_STATIC case
