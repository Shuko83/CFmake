# Modfied file from FindOpenSSL Official CMake module from cmake 3.30.5
...
if(OPENSSL_FOUND)
  if(NOT TARGET OpenSSL::Crypto AND
    ...
    if( "${CMAKE_SIZEOF_VOID_P}" STREQUAL "8" )
      set(_OPENSSL_ARCH_SUFFIX "-x64")
    else()
      set(_OPENSSL_ARCH_SUFFIX "")
    endif()  
 
    # Set properties for IMPORTED_IMPLIB and locations
    if(EXISTS "${OPENSSL_CRYPTO_LIBRARY}")
      if(WIN32 AND NOT OPENSSL_USE_STATIC_LIBS)
        string(REPLACE "libcrypto.lib" "../bin/libcrypto-${OPENSSL_VERSION_MAJOR}_${OPENSSL_VERSION_MINOR}${_OPENSSL_ARCH_SUFFIX}.dll" OPENSSL_CRYPTO_LIBRARY_RUNTIME "${OPENSSL_CRYPTO_LIBRARY}")
        set_target_properties(OpenSSL::Crypto PROPERTIES
          IMPORTED_LINK_INTERFACE_LANGUAGES "C"
          IMPORTED_IMPLIB "${OPENSSL_CRYPTO_LIBRARY}"
          IMPORTED_LOCATION "${OPENSSL_CRYPTO_LIBRARY_RUNTIME}")
      else()
        set_target_properties(OpenSSL::Crypto PROPERTIES
          IMPORTED_LINK_INTERFACE_LANGUAGES "C"
    ...
    if(EXISTS "${LIB_EAY_LIBRARY_RELEASE}")
      ...
      if(WIN32 AND NOT OPENSSL_USE_STATIC_LIBS)
        string(REPLACE "libcrypto.lib" "../bin/libcrypto-${OPENSSL_VERSION_MAJOR}_${OPENSSL_VERSION_MINOR}${_OPENSSL_ARCH_SUFFIX}.dll" LIB_EAY_LIBRARY_RELEASE_RUNTIME "${LIB_EAY_LIBRARY_RELEASE}")
          set_target_properties(OpenSSL::Crypto PROPERTIES
            IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "C"
            IMPORTED_IMPLIB_RELEASE "${LIB_EAY_LIBRARY_RELEASE}"
            IMPORTED_LOCATION_RELEASE "${LIB_EAY_LIBRARY_RELEASE_RUNTIME}")
      else()  
        set_target_properties(OpenSSL::Crypto PROPERTIES
          IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "C"
    ...
    if(EXISTS "${LIB_EAY_LIBRARY_DEBUG}")
      set_property(TARGET OpenSSL::Crypto APPEND PROPERTY
        ...
        if(WIN32 AND NOT OPENSSL_USE_STATIC_LIBS)
          string(REPLACE "libcrypto.lib" "../bin/libcrypto-${OPENSSL_VERSION_MAJOR}_${OPENSSL_VERSION_MINOR}${_OPENSSL_ARCH_SUFFIX}.dll" LIB_EAY_LIBRARY_DEBUG_RUNTIME "${LIB_EAY_LIBRARY_DEBUG}")
            set_target_properties(OpenSSL::Crypto PROPERTIES
              IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "C"
              IMPORTED_IMPLIB_DEBUG  "${LIB_EAY_LIBRARY_DEBUG}"
              IMPORTED_LOCATION_DEBUG "${LIB_EAY_LIBRARY_DEBUG_RUNTIME}")
        else()  
          set_target_properties(OpenSSL::Crypto PROPERTIES
            IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "C"
  ...
  if(NOT TARGET OpenSSL::SSL AND
    ...
    if(EXISTS "${OPENSSL_SSL_LIBRARY}")
      if(WIN32 AND NOT OPENSSL_USE_STATIC_LIBS)
        string(REPLACE "libssl.lib" "../bin/libssl-${OPENSSL_VERSION_MAJOR}_${OPENSSL_VERSION_MINOR}${_OPENSSL_ARCH_SUFFIX}.dll" OPENSSL_SSL_LIBRARY_RUNTIME "${OPENSSL_SSL_LIBRARY}")
        set_target_properties(OpenSSL::SSL PROPERTIES
          IMPORTED_LINK_INTERFACE_LANGUAGES "C"
          IMPORTED_IMPLIB "${OPENSSL_SSL_LIBRARY}"
          IMPORTED_LOCATION "${OPENSSL_SSL_LIBRARY_RUNTIME}")
      else()
        set_target_properties(OpenSSL::SSL PROPERTIES
          IMPORTED_LINK_INTERFACE_LANGUAGES "C"
    ...
    if(EXISTS "${SSL_EAY_LIBRARY_RELEASE}")
      ...
      IMPORTED_CONFIGURATIONS RELEASE)
      if(WIN32 AND NOT OPENSSL_USE_STATIC_LIBS)
          string(REPLACE "libssl.lib" "../bin/libssl-${OPENSSL_VERSION_MAJOR}_${OPENSSL_VERSION_MINOR}${_OPENSSL_ARCH_SUFFIX}.dll" SSL_EAY_LIBRARY_RELEASE_RUNTIME "${SSL_EAY_LIBRARY_RELEASE}")
          set_target_properties(OpenSSL::SSL PROPERTIES
          IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "C"
          IMPORTED_IMPLIB_RELEASE "${SSL_EAY_LIBRARY_RELEASE}"
          IMPORTED_LOCATION_RELEASE "${SSL_EAY_LIBRARY_RELEASE_RUNTIME}")
      else()  
          set_target_properties(OpenSSL::SSL PROPERTIES
          IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "C"
    ...
    if(EXISTS "${SSL_EAY_LIBRARY_DEBUG}")
      set_property(TARGET OpenSSL::SSL APPEND PROPERTY
        IMPORTED_CONFIGURATIONS DEBUG)
        if(WIN32 AND NOT OPENSSL_USE_STATIC_LIBS)
          string(REPLACE "libssl.lib" "../bin/libssl-${OPENSSL_VERSION_MAJOR}_${OPENSSL_VERSION_MINOR}${_OPENSSL_ARCH_SUFFIX}.dll" SSL_EAY_LIBRARY_DEBUG_RUNTIME "${SSL_EAY_LIBRARY_DEBUG}")
          set_target_properties(OpenSSL::SSL PROPERTIES
          IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "C"
          IMPORTED_IMPLIB_DEBUG "${SSL_EAY_LIBRARY_DEBUG}"
          IMPORTED_LOCATION_DEBUG  "${SSL_EAY_LIBRARY_DEBUG_RUNTIME}")
      else()  
        set_target_properties(OpenSSL::SSL PROPERTIES
          IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "C"
