...
set(DELIVERY_DIR "C:/tt4-cmake/Starlinx/Modules/DLPX/HI/Models/DlpStarlinx/")
...
add_library(${fileName} SHARED IMPORTED)
  ...
  set_target_properties(${fileName} PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "${DELIVERY_DIR}/include;${DELIVERY_DIR}/include/Starlinx/Objects;${DELIVERY_DIR}/include/Starlinx/OrderReaders;${DELIVERY_DIR}/include/Starlinx/OrderWriters;${DELIVERY_DIR}/include/Starlinx/ReportReaders;${DELIVERY_DIR}/include/Starlinx/ReportWriters")
endif()
endforeach()
