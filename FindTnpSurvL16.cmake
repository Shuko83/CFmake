...
set(DELIVERY_DIR "C:/tt4-cmake/Starlinx/Modules/DLPX/HI/Models/TnpSurv/L16/ED8/Delivery")
...
add_library(${fileName} SHARED IMPORTED)
  ...
  set_target_properties(${fileName} PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "${DELIVERY_DIR}/include;${DELIVERY_DIR}/include;${DELIVERY_DIR}/include/TnpSurvL16/Objects;${DELIVERY_DIR}/include/TnpSurvL16/OrderReaders;${DELIVERY_DIR}/include/TnpSurvL16/OrderWriters;${DELIVERY_DIR}/include/TnpSurvL16/ReportReaders;${DELIVERY_DIR}/include/TnpSurvL16/ReportWriters")
endif()
endforeach()
