...
set(DELIVERY_DIR "C:/tt4-cmake/Starlinx/Modules/DLPX/HI/Models/Tnp/L22/ED6/Delivery")
...
add_library(${fileName} SHARED IMPORTED)
  ...
  set_target_properties(${fileName} PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "${DELIVERY_DIR}/include;${DELIVERY_DIR}/include/TnpL22/Objects;${DELIVERY_DIR}/include/TnpL22/OrderReaders;${DELIVERY_DIR}/include/TnpL22/OrderWriters;${DELIVERY_DIR}/include/TnpL22/ReportReaders;${DELIVERY_DIR}/include/TnpL22/ReportWriters")
endif()
endforeach()
