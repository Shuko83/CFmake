...
set(DELIVERY_DIR "C:/tt4-cmake/Starlinx/Components/VirtualGeo/Delivery")
...
foreach(lib ${LIBS_LIST})
  ...
  continue()
    ...
    if (NOT TARGET ${fileName})
      ...
      target_compile_definitions(${fileName} INTERFACE "VR_64")
      if (NOT ${fileName} STREQUAL "VirtualGeo")
        target_link_libraries(VirtualGeo INTERFACE ${fileName})
      endif()
  endif()
endforeach()
